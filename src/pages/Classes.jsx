...
const classes = [
  { title: 'Asian Noodle Night', date: 'June 16, 2026 · 8:00 PM', teacher: 'Chef Marco Lin', price: '₹8900', img: 'https://www.recipetineats.com/tachyon/2019/11/Lo-Mein_5.jpg', desc: 'Discover the art of handmade noodles. Learn Noodle Soup and Sea Curry from scratch — from dough to bowl.' },
  { title: 'Italian Pizza & Pasta', date: 'July 4, 2026 · 7:00 PM', teacher: 'Chef Sofia Bianchi', price: '₹9500', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnJj_QI73JR9iWLcPnz-ds5XOQb74HOLfD5A&s', desc: 'Master wood-fired pizza dough and handmade pasta. Enjoy a meal with wine pairing at the end.' },
